...
func (p *TCInternacional) Parsear(path string, _ int) ([]movimientos.MovimientoBruto, error) {
...
func filasTCIAMovimientos(filas []filaTCI) ([]movimientos.MovimientoBruto, error) {
