...
func (p *CuentaCorriente) Parsear(path string, año int) ([]movimientos.MovimientoBruto, error) {
...
func filasAMovimientos(filas []filaCC, año int) ([]movimientos.MovimientoBruto, error) {
